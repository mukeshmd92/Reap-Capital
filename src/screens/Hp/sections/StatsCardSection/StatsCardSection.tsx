...
const StatsCardSection = () => {
  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-3">
            ...
            >
              <Card className="w-full h-auto bg-white rounded-[60px_20px_20px_20px] border border-solid border-[#c2c2c2]">
                <CardContent className="p-0">
                  <div className="relative h-auto m-[5px] rounded-[55px_14px_14px_14px] flex flex-col items-center sm:items-baseline  justify-center sm:justify-baseline bg-white p-5 overflow-hidden shadow-[0px_13px_28px_#0000001a,0px_11px_51px_#00000017,0px_115px_69px_#0000000d,0px_205px_82px_#00000003,0px_320px_90px_transparent]">
                    <div className=" w-[180px] h-auto sm:w-[90px] lg:w-[120px]">
                      <img

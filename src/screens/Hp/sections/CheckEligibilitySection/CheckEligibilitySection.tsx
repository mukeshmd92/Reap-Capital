...
const CheckEligibilitySection = () => {
  return (
    <section className="w-full bg-black">
      <div className="w-full h-[5rem] sm:h-[5rem] lg:h-[6rem] bg-white -mt-4 z-10"></div>
      <div
      ...
      >
        ...
        <div className="max-w-[90%] sm:max-w-[80%] lg:max-w-[42rem] w-full flex flex-col items-center justify-center pt-[4rem] sm:pt-[6rem] lg:pt-[10rem] pb-[3rem] sm:pb-[4rem] lg:pb-[5rem] px-4 sm:px-6 lg:px-0">
          ...
          <div className="font-normal mt-6 sm:mt-6 text-[#ffffffe6] text-base sm:text-lg md:text-xl lg:text-[1.125rem] text-center leading-5 sm:leading-6 lg:leading-[27px] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:1000ms] max-w-[90%] sm:max-w-[80%] lg:max-w-full">
          ...
          <Button className="mt-6 sm:mt-8 lg:mt-10 w-[180px] sm:w-[190px] lg:w-[206px] h-[50px] sm:h-[54px] lg:h-[58px] bg-black rounded-[16px] sm:rounded-[18px] lg:rounded-[20px] border-[0.5px] border-solid  border-[#ffffff] shadow-[0px_1px_3px_#0000001a,0px_5px_5px_#00000017,0px_11px_7px_#0000000d,0px_20px_8px_#00000003,0px_31px_9px_transparent,inset_0px_0px_3px_5px_#71ffcd66] [font-family:'Inter_Variable-Medium',Helvetica] font-medium text-white text-sm sm:text-base lg:text-lg text-center tracking-[-0.3px] sm:tracking-[-0.4px] lg:tracking-[-0.54px] leading-[normal] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:1200ms] hover:bg-gray-900 transition-colors cursor-pointer">
            Start Your Process
          </Button>
        </div>
      </div>

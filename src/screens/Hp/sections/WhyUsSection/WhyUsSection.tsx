  ...
  return (
    <section className="w-full px-4 py-16">
      ...
      <div className="flex gap-6 items-center max-w-[75rem] mx-auto mt-10">
        ...
        >
          <img src={IMAGES.WhyImgOne} alt="Why Us" className="scale-110 object-cover" />
        ...
        >
          <img src={IMAGES.WhyImgTwo} alt="Why Us" className="scale-110 object-cover" />
      ...
      <div className="flex gap-6 items-center max-w-[75rem] mx-auto mt-10">
        {[
          ...
          >
            <img src={card.img} alt="Why Us" className="scale-110 object-cover" />
            <div className="p-6 pt-10 bg-gradient-to-b from-green-100 to-white">
              <h4 className="text-gray-900 font-semibold mb-2 text-[1.65rem]">
                {card.title}
              </h4>
              <p className="text-gray-700 text-[1rem] max-w-[25rem]">{card.text}</p>
            </div>
          </motion.div>
        ))}
      </div>

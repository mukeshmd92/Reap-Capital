...
const WhyUsSection = () => {
  return (
    <section className="w-full px-4 py-8 md:py-16 lg:mt-10">
      <motion.header
      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="flex flex-col items-center  font-medium text-3xl md:text-5xl text-center tracking-[-1.44px] leading-[40px] md:leading-[68px] mb-4 md:mb-6">
            <span className="text-black tracking-[-0.69px]">Why Choose </span>
            <span className="text-[#0aa26c] tracking-[-0.69px]">
              Reap Capital?
            </span>
          </h2>
          <p className=" font-normal text-neutral-700 text-base md:text-lg text-center tracking-[0] leading-[22px] md:leading-[26px]">
      ...
      {/* row of 2 */}
      <div className="flex flex-col md:flex-row gap-6  md:max-w-[75rem] mx-auto mt-10">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="w-full  md:w-[60%] mx-auto rounded-3xl rounded-tl-[3.5rem] overflow-hidden shadow-md"
        >
          <img
          ...
          />
          <div className="p-6 bg-gradient-to-b from-green-100 to-white  md:text-left">
            <h4 className="text-gray-900 font-semibold mb-2 text-[1.75rem]">
              Fast Approvals
            </h4>
            <p className="text-gray-700 text-sm md:text-lg max-w-[25rem] mx-auto md:mx-0">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="w-full md:w-[40%] mx-auto rounded-3xl rounded-tl-[3.5rem] overflow-hidden shadow-md"
        >
          <img
            src={IMAGES.WhyImgTwo}
            alt="Why Us"
            className="h-72 md:h-[22rem]  object-cover"
          />
          <div className="p-6 pt-10 bg-gradient-to-b from-green-100 to-white  md:text-left">
            <h4 className="text-gray-900 font-semibold mb-2 text-[1.75rem]">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-center max-w-[75rem] mx-auto mt-10">
        {[
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-full md:w-[33%] mx-auto rounded-3xl rounded-tl-[3.5rem] overflow-hidden shadow-md"
          >
            <img
              src={card.img}
              alt="Why Us"
              className=" md:scale-110 object-cover"
            />
            <div className="p-6 pt-10 bg-gradient-to-b from-green-100 to-white  md:text-left">
              <h4 className="text-gray-900 font-semibold mb-2 text-[1.65rem]">
                {card.title}
              </h4>
              <p className="text-gray-700 text-[1rem] max-w-[25rem] mx-auto md:mx-0">
                {card.text}
              </p>
            </div>
          </motion.div>
